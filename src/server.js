...
// SUB-DOMAINS
const raj_patel = require('src/routes/rajpatel/rajpatel')
const jake_maschoff = require('src/routes/jakemaschoff/jakemaschoff')
const melvin_bosnjak = require('src/routes/melvinbosnjak/melvinbosnjak')
const adam_lee = require('src/routes/adamlee/adamlee')
...
app.use(sub_domain('beacon', beacon))
app.use('/', home)
...
logger.info(`rajpatel`)
logger.info(`jakemaschoff`)
logger.info(`melvinbosnjak`)
logger.info(`adamlee`)
logger.info(`beacon`)
logger.info(``)
